...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->cover_screen_del = false;
    ui->display_screen_del = false;
    ui->config_screen_del = false;
}

void setup_ui(lv_ui *ui)
{
    init_scr_del_flag(ui);
    setup_scr_cover_screen(ui);
    setup_scr_config_screen(ui);
    setup_scr_display_screen(ui);
    lv_scr_load(ui->cover_screen);
}
