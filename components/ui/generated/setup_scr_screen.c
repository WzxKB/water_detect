...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_img_1, &_687bff6831832d745e6891a5df94b7261303614780_alpha_236x237);
    lv_img_set_pivot(ui->screen_img_1, 50,50);
    lv_img_set_angle(ui->screen_img_1, 0);
    lv_obj_set_pos(ui->screen_img_1, -1, 1);
    lv_obj_set_size(ui->screen_img_1, 236, 237);
    ...
    lv_obj_set_pos(ui->screen_btn_1, 87, 211);
    lv_obj_set_size(ui->screen_btn_1, 68, 27);
    ...
    lv_label_set_text(ui->screen_label_1, "wzx\n");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_1, 72, 153);
